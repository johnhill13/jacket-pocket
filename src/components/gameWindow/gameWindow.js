            ...
            <>
                <Container>
                    <Segment className="questions-container" raised>
                        ...
                        {this.state.response && !this.state.score && <AnswerContainer game={this.state.game} player={this.state.player} answer={this.state.response[this.state.response.length - 1]}/>}
